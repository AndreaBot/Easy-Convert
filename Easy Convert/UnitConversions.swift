...
struct UnitConversions {
    ...
    static let conversionFactors: [String: Double] = [
    ...
    static func convert(value: Double, startUnit: String, targetUnit: String) -> Double {
    ...
    static func convertTemperature(value: Double, startUnit: String, targetUnit: String) -> Double {
    ...
    static func convertSymbols(symbol: String) -> String {
        switch symbol {
